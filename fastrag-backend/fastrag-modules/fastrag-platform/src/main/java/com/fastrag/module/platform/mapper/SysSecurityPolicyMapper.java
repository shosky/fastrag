 ...
 * 安全策略 Mapper 接口
 * <p>
 * 继承 MyBatis-Plus 的 BaseMapper，提供 {@link com.fastrag.module.platform.entity.SysSecurityPolicy}
 * 实体的数据库持久化操作。对应数据库表 {@code sys_security_policy}。
...
@Mapper public interface SysSecurityPolicyMapper extends BaseMapper<SysSecurityPolicy> {}
