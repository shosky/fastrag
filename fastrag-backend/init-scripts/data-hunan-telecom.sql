...
('user_zhang_jg', 'zhangjianguo', '张建国', '0731-85100001', 'zhangjianguo@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_super_admin', 'enabled', 'org_han_zonghe', 10737418240, 0),
...
('user_wang_xy',   'wangxiuying', '王秀英', '0731-85101001', 'wangxiuying@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_zonghe', 10737418240, 0),
('user_wang_lin',  'wanglin',     '王琳',   '0731-85101002', 'wanglin@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_office', 10737418240, 0),
('user_liu_yf',    'liuyanfang',  '刘艳芳', '0731-85101003', 'liuyanfang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_logistics', 10737418240, 0);

-- ---- 人力资源部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_chen_zq',   'chenzhiqiang','陈志强', '0731-85102001', 'chenzhiqiang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_hr', 10737418240, 0),
('user_jiang_t',   'jiangtao',    '蒋涛',   '0731-85102002', 'jiangtao@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_hr', 10737418240, 0);

-- ---- 财务部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_liu_fn',    'liufang',     '刘芳',   '0731-85103001', 'liufang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_finance', 10737418240, 0),
('user_yuan_fn',   'yuanfang',    '袁芳',   '0731-85103002', 'yuanfang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_finance', 10737418240, 0);

-- ---- 政企客户部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_zhao_dp',   'zhaodapeng',  '赵大鹏', '0731-85104001', 'zhaodapeng@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_gov', 10737418240, 0),
('user_peng_l',    'pengli',      '彭丽',   '0731-85104002', 'pengli@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_gov', 10737418240, 0);

-- ---- 个人客户部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_sun_lh',    'sunlihua',    '孙丽华', '0731-85105001', 'sunlihua@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_consumer', 10737418240, 0),
('user_he_xy',     'hexiaoyan',   '何小燕', '0731-85105002', 'hexiaoyan@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_consumer', 10737418240, 0);

-- ---- 网络部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_zhou_w',    'zhouwei',     '周伟',   '0731-85106001', 'zhouwei@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_network', 10737418240, 0),
('user_dong_w',    'dongwei',     '董伟',   '0731-85106002', 'dongwei@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_ops', 10737418240, 0),
('user_xu_hb',     'xuhongbin',   '徐红兵', '0731-85106003', 'xuhongbin@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_resource', 10737418240, 0);

-- ---- 技术部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_wu_xf',     'wuxiaofeng',  '吴晓峰', '0731-85107001', 'wuxiaofeng@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_tech', 10737418240, 0),
('user_cao_l',     'caolei',      '曹磊',   '0731-85107002', 'caolei@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_rd', 10737418240, 0),
('user_tang_y',    'tangyu',      '唐宇',   '0731-85107003', 'tangyu@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_innovation', 10737418240, 0);

-- ---- 数据智能部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_zheng_yw',  'zhengyawen',  '郑雅文', '0731-85108001', 'zhengyawen@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_data', 10737418240, 0),
('user_feng_xh',   'fengxiaohong', '冯晓红', '0731-85108002', 'fengxiaohong@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_kb_admin', 'enabled', 'org_han_data', 10737418240, 0);

-- ---- 云网运营部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_ma_c',      'machao',      '马超',   '0731-85109001', 'machao@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_cloud', 10737418240, 0);

-- ---- 安全部 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_lin_j',     'linjing',     '林静',   '0731-85110001', 'linjing@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_security', 10737418240, 0);

-- ---- 长沙分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_huang_zy',  'huangzhiyuan', '黄志远', '0731-85120001', 'huangzhiyuan@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_cs', 10737418240, 0),
('user_zhang_m',   'zhangming',   '张明',   '0731-85120002', 'zhangming@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_cs_furong', 10737418240, 0);

-- ---- 株洲分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_yang_xl',   'yangxiulan',  '杨秀兰', '0733-28100001', 'yangxiulan@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_zz', 10737418240, 0);

-- ---- 湘潭分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_xu_jh',     'xujianhua',   '许建华', '0731-58200001', 'xujianhua@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_xt', 10737418240, 0);

-- ---- 衡阳分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_he_jp',     'hejianping',  '何建平', '0734-81400001', 'hejianping@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_hy', 10737418240, 0),
('user_liu_hy',    'liuhaiyang',  '刘海阳', '0734-81400002', 'liuhaiyang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_staff',    'enabled', 'org_han_hy_zhongshan', 10737418240, 0);

-- ---- 邵阳分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_luo_m',     'luomin',      '罗敏',   '0739-5010001', 'luomin@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_sy', 10737418240, 0);

-- ---- 岳阳分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_xie_zg',    'xiezhigang',  '谢志刚', '0730-8840001', 'xiezhigang@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_yy', 10737418240, 0);

-- ---- 常德分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_tang_mh',   'tangminghui', '唐明辉', '0736-7320001', 'tangminghui@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_cd', 10737418240, 0);

-- ---- 张家界分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_hu_wj',     'huwenjuan',   '胡文娟', '0744-8220001', 'huwenjuan@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_zjj', 10737418240, 0);

-- ---- 益阳分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_zhou_cm',   'zhouchenming', '周晨明', '0737-4310001', 'zhouchenming@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_yiyang', 10737418240, 0);

-- ---- 娄底分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_lei_j',     'leijun',      '雷军',   '0738-8920001', 'leijun@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_ld', 10737418240, 0);

-- ---- 郴州分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_chen_dh',   'chen Dahai',   '陈大海', '0735-2220001', 'chendahai@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_cz', 10737418240, 0);

-- ---- 永州分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_ou_yh',     'ouyanghui',   '欧阳辉', '0746-8440001', 'ouyanghui@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_yz', 10737418240, 0);

-- ---- 怀化分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_tan_y',     'tanyong',     '谭勇',   '0745-2710001', 'tanyong@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_hh', 10737418240, 0);

-- ---- 湘西分公司 ----
INSERT IGNORE INTO sys_user (id, username, real_name, phone, email, password_hash, role_id, status, org_id, storage_quota, storage_used) VALUES
('user_bian_wm',   'bianweimin',  '卞伟民', '0743-8750001', 'bianweimin@hn.chinatelecom.com',
 '$2b$10$7.qN.uqPj.wQpQj.5A4S..NJuGzDZZP0v9pW8vGv8l5GXjW5q6Ka', 'role_dept_mgr', 'enabled', 'org_han_xx', 10737418240, 0);

-- ==================== 超级管理员（更新组织归属） ====================
UPDATE sys_user SET org_id = 'org_han_zonghe' WHERE id = 'user_admin';
